...
//
//   static const String createSpecialDateCategory = '/special-dates/create/category';
//
//   static const String createSpecialDateOccasion = '/special-dates/create/occasion';
//
//   static const String createSpecialDateDate = '/special-dates/create/date';
//   static const String createSpecialDateDetails = '/special-dates/create/details';
...
//
//             debugPrint('Repeats: ${updated.repeatsYearly}');
//
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        // ------------------------------------------------------------
          ...
          category =
          extra['category'] as SpecialDateCategory;
          ...
          repeatsYearly =
          extra['repeatsYearly'] as bool;

          reminderDays =
          extra['reminderDays'] as int;
        ...
        // ------------------------------------------------------------
          ...
          return const Scaffold(
            body: Center(
              child: Text(
                'Unable to open this special date.',
              ),
            ),
          );
        }
      ...
      builder: (context, state) {
        ...
        // ------------------------------------------------------------
          ...
          return const Scaffold(
            body: Center(
              child: Text(
                'Unable to edit this special date.',
              ),
            ),
          );
        }
        ...
        return EditSpecialDateScreen(
          ...
          onSave: (updated) {
            debugPrint(
              'Updated special date: ${updated.title}',
            );
            ...
            debugPrint(
              'Category: ${updated.originalCategory}',
            );

            debugPrint(
              'Repeats yearly: ${updated.repeatsYearly}',
            );

            debugPrint(
              'Reminder: ${updated.reminderDays}',
            );
